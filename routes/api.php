...
Route::middleware('auth:sanctum')->post('insertarcomentario','cruid\controlador@Insertarcomentario');
...
Route::middleware('auth:sanctum')->put('actualizarcomentario/{id}','cruid\controlador@Actualizarcomentario')->where (['id'=>'[0-9]+']);
